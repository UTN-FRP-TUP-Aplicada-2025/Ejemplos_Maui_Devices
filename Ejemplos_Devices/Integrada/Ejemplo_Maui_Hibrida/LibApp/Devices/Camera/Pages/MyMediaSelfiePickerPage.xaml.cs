...
namespace LibApp.Devices.Camera.Pages;
...
public partial class MyMediaSelfiePickerPage : ContentPage
{
    ...
    private async Task EvaluarYMostrarEstadoPermisoAsync()
    {
        ...
        MostrarOverlayPermiso(titulo: puedeReintentar ? "Permiso de cámara necesario" : "Acceso a la cámara denegado",
            mensaje: puedeReintentar ? "Para tomar fotos necesitamos acceso a la cámara. Podés intentar conceder el permiso." : "Para tomar fotos necesitamos acceso a la cámara. Habilitalo desde los ajustes de la aplicación.",
