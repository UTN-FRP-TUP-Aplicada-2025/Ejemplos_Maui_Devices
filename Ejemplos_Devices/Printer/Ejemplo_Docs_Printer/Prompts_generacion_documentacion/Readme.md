...
Se especifica en el fichero [01_Prompt_chatgpt.md](01_Prompt_chatgpt.md) el prompt y la respuesta
...
genere los manuales con el contenido apropiado definido en 
el anterior prompt, revisando y ajustando algunos detalles.

Extrayendo desde la respuesta dada en [01_Prompt_chatgpt.md](01_Prompt_chatgpt.md) se 
genera un prompt con las especificaciones necesarias, [02_Prompt_copilot.md](02_Prompt_copilot.md),
ubicandose en la raiz del proyecto Ejemplo_ThermalPrinter y luego 
por medio del siguiente prompt desde el copilot se crea la documentación
...
[02_Prompt_copilot.md](02_Prompt_copilot.md)
...
Solicitud a copilot de forma desestructurada.

Se generó un documento general a partir de una consulta desde copilot no 
muy bien organizada.
