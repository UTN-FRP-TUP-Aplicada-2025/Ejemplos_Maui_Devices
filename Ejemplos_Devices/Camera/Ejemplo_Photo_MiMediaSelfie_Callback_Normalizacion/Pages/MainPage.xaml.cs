...
using Ejemplo_Photo_MiMediaSelfie_Callback_Normalizacion.Utilities;

namespace Ejemplo_Photo_MiMediaSelfie_Callback_Normalizacion.Pages;
...
public partial class MainPage : ContentPage
{
    ...
    async private void OnAbrirCamaraClicked(object? sender, EventArgs e)
    {
        ...
        try
        {
            ...
            await Shell.Current.GoToAsync(nameof(MyMediaSelfiePickerPage), pageParams);
        }
        catch (Exception ex)
        {
